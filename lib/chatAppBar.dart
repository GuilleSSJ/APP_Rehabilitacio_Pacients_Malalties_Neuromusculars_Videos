...
class ChatAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    var textHeading = TextStyle(color: Colors.white, fontSize: 20); // Text style for the name
    var textStyle = TextStyle(color: Colors.white); // Text style for everything else
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    mainAxisSize: MainAxisSize.min,
                                    children: <Widget>[
                                      Text('Pacient', style: textHeading),
                                      Text('@pacient', style: textStyle)
                                    ],
                                  ))),
                            ],
                          )),
